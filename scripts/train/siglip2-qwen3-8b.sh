...
PRETRAIN_OUTPUT_DIR=${PRETRAIN_OUTPUT_DIR:-checkpoints/siglip2-qwen3-next-8B-pretrain}
SFT_OUTPUT_DIR=${SFT_OUTPUT_DIR:-checkpoints/siglip2-qwen3-next-8B-sft-779k-lora}
