...
# SigLIP2 + Qwen2.5-3B: 773k MMCS pretraining followed by 779k LLaVA-NeXT LoRA SFT.
MASTER_PORT=${MASTER_PORT:-$(shuf -i 20001-29999 -n 1)}
NUM_GPUS=${NUM_GPUS:-8}
VISION_MODEL_PATH=${VISION_MODEL_PATH:-google/siglip2-so400m-patch16-384}
LANGUAGE_MODEL_PATH=${LANGUAGE_MODEL_PATH:-Qwen/Qwen2.5-3B-Instruct}
PRETRAIN_RECIPE=${PRETRAIN_RECIPE:-train/recipe/mmcs.json}
SFT_RECIPE=${SFT_RECIPE:-train/recipe/sft_779k.json}
PRETRAIN_OUTPUT_DIR=${PRETRAIN_OUTPUT_DIR:-checkpoints/siglip2-qwen25-next-3B-pretrain}
SFT_OUTPUT_DIR=${SFT_OUTPUT_DIR:-checkpoints/siglip2-qwen25-next-3B-sft-779k-lora}
