...
from model.llava_next_qwen3.configuration_llava_next_qwen3 import LlavaNextQwen3Config
from model.projectors import PatchMerger


class LlavaNextQwen3ForCausalLM(PreTrainedModel):
    config_class = LlavaNextQwen3Config
    main_input_name = "inputs_embeds"
    base_model_prefix = "language_model"
    _no_split_modules = ["CLIPVisionModel", "SiglipVisionModel", "Qwen3DecoderLayer"]
    _supports_flash_attn_2 = True
    supports_gradient_checkpointing = True

    def __init__(
        self,
        config: LlavaNextQwen3Config,
