...
from model.llava_next_llama.configuration_llava_next_llama import LlavaNextLlamaConfig
from model.projectors import PatchMerger


class LlavaNextLlamaForCausalLM(PreTrainedModel):
    config_class = LlavaNextLlamaConfig
    main_input_name = "inputs_embeds"
    base_model_prefix = "language_model"
    _no_split_modules = ["CLIPVisionModel", "SiglipVisionModel", "LlamaDecoderLayer"]
    _supports_flash_attn_2 = True
    supports_gradient_checkpointing = True

    def __init__(
        self,
        config: LlavaNextLlamaConfig,
        ...
        self.pad_token_id = 128009  # eos_token_id of LlamaTokenizer
